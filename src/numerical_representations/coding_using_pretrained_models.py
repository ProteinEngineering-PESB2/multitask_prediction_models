...
column_with_response1 = "expression"
column_with_response2 = "activity"
...
try:
    ...
    df_data[column_with_response1] = input_data[column_with_response1]
    df_data[column_with_response2] = input_data[column_with_response2]
